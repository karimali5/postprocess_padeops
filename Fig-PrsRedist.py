...
plot_slices(
        [
            {
                "filename": [
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget3_term03_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                ],
                "name": r"$\mathcal{R}_{\Delta b}$",
            ...
            {
                "filename": [
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget3_term02_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                ],
                "name": r"$\mathcal{R}_{b \Delta}$",
                #"blh_file": blh_files_y(S800_5K, yfarm),
                'fieldgain': 10000,
                's': 3,
            },
            ...
            {
                "filename": [
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget3_term01_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                ],
                "name": r"$\mathcal{R}_{\Delta \Delta}$",
                #"blh_file": blh_files_y(S800_5K, yfarm),
                'fieldgain': 10000,
                's': 3,
            },
