...
plot_slices(
        [
            {
                "filename": [
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget3_term11_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                ],
                "name": r"$\mathcal{B}_{\Delta b}$",
            ...
            {
                "filename": [
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget3_term12_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                ],
                "name": r"$\mathcal{B}_{b \Delta}$",
                #"blh_file": blh_files_y(S800_5K, yfarm),
                'fieldgain': 1000000,
                's': 5,
            },
            ...
            {
                "filename": [
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget3_term10_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                ],
                "name": r"$\mathcal{B}_{\Delta \Delta}$",
                #"blh_file": blh_files_y(S800_5K, yfarm),
                'fieldgain': 1000000,
                's': 5,
            },
        ...
        **colorbar_style,
        **font_style,
        export=f"TKEBouyancy_x=165.png",
    )
