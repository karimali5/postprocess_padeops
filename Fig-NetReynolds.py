...
plot_slices(
        [
            {
                "filename": [
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget2_term01_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget2_term04_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget2_term07_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                ],
                "name": r"$-\Delta \partial_j\overline{u^\prime u_j^\prime}$",
            ...
            {
                "filename": [
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget2_term02_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget2_term05_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget2_term08_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                ],
                "name": r"$-\Delta \partial_j\overline{v^\prime u_j^\prime}$",
                #"blh_file": blh_files_y(S800_5K, yfarm),
                'fieldgain': -1000,
                's': 4,
            },
            ...
            {
                "filename": [
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget2_term03_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget2_term06_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                    os.path.join(S800_5K["path"], f"Run09_comp_deficit_budget2_term09_t"+S800_5K["timestamp"]+"_n"+S800_5K["nstamp"]+f"_SL_x={165}.nc"),
                ],
                "name": r"$-\Delta \partial_j\overline{w^\prime u_j^\prime}$",
                #"blh_file": blh_files_y(S800_5K, yfarm),
                'fieldgain': -1000,
                's': 4,
            },
        ...
        **colorbar_style,
        **font_style,
        export=f"NetReynolds_x=165.png",
    )
