...
def _apply_profile_offset(x, y, offset):
    if offset is None:
        return y
    ...
    if isinstance(offset, (int, float, np.number)):
        ...
        x_sorted = x[sort_idx]
        y_sorted = y[sort_idx]
        if offset < x_sorted[0] or offset > x_sorted[-1]:
            raise ValueError(
                f"Offset coordinate {offset} is outside profile range "
                f"[{x_sorted[0]}, {x_sorted[-1]}]."
            )
        offset_value = np.interp(float(offset), x_sorted, y_sorted)
        return y - offset_value

    x_offset, y_offset = load_profile(offset)
    x_offset = np.asarray(x_offset)
    if x.shape != x_offset.shape or not np.allclose(x, x_offset):
        raise ValueError(f"Profile x-coordinates do not match offset file {offset}.")
    return y - np.asarray(y_offset)
...
def plot_profiles(profiles, **kwargs):
    ...
    profiles : list of dict
        List of profile dictionaries to plot. Each dictionary must include
        'file' and may include 'offset'. If 'offset' is a CSV path, subtract
        that profile before applying 'ygain'. If it is numeric, treat it as a
        raw x-coordinate in the profile file, interpolate the profile value
        there, and subtract that scalar before applying 'ygain'.
    **kwargs : dict
...
def plot_profile_panels(profile_panels, **kwargs):
    ...
    with plt.rc_context({"text.usetex": True, "font.family": "serif"}):
        ...
        for panel_index, (ax, panel) in enumerate(zip(axes, profile_panels)):
            panel_profiles = panel.get("profiles", panel)
            panel_title = panel.get("title", None)
            panel_xlabel = panel.get("xlabel", xlabel)
            panel_ylabel = panel.get("ylabel", ylabel if panel_index == 0 else None)
            panel_legend = panel.get("legend", legend)
            ...
            if panel_legend:
                ax.legend(
                    loc=panel.get("legend_loc", legend_loc),
                    ncol=panel.get("legend_ncols", legend_ncols),
                    frameon=legend_frameon,
                    fontsize=legend_fontsize,
                    **panel_legend_kwargs,
                )
...
lateral_profiles = [
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget6_term(07+08+09)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\overline{u}^b_j \partial_j \Delta{\overline{v}}$',
        'color': 'k',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget6_term(04+05+06)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\Delta \overline{u}_j \partial_j {\overline{v}^b}$',
        'color': 'tab:green',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget6_term(01+02+03)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\Delta \overline{u}_j \partial_j \Delta{\overline{v}}$',
        'color': 'tab:red',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
    ...
    {
        'file':'/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget0_term19_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv',
        'label': r'$\partial_y \Delta \overline{p}$',
        'color': 'tab:blue',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget6_term(16+17+18)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\partial_j \overline{\Delta v^\prime \Delta u_j^\prime}$',
        'color': 'tab:orange',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget6_term(19+20+21+22+23+24)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\partial_j \overline{\Delta v^\prime  {u_j^\prime}^b} +\partial_j \overline{ {v^\prime}^b  \Delta {u_j^\prime}}$',
        'color': 'purple',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
        #'offset': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget6_term(19+20+21+22+23+24)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'offset':40,
    },

    {
        'file':'/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget0_term13_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv',
        'label': r'$\partial_j \Delta \overline{\tau}_{2j}$',
        'color': 'tab:cyan',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
    ...
    {
        'file':'/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget0_term16_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv',
        'label': r'${2}{\mathrm{Ro}}^{-1} \sin{\phi} \,\Delta{\overline{u}}$',
        'color': 'tab:brown',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
...
vertical_profiles = [
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget7_term(07+08+09)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\overline{u}^b_j \partial_j \Delta{\overline{w}}$',
        'color': 'k',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
        #'offset': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget7_term(19+20+21+22+23+24)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    },
    
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget7_term(04+05+06)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget7_term(01+02+03)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    ...
    {
        'file':'/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget0_term20_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv',
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget7_term(16+17+18)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget7_term(19+20+21+22+23+24)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    ...
    {
        'file':'/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget0_term14_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv',
    ...
    {
        'file':'/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget0_term17_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv',
        'label': r'$\Delta \overline{\theta}_{\perp}/(\theta_0 {\mathrm{Fr}}^2)$',
        'color': 'tab:brown',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
...
profile_panels = [
    {
        "profiles": lateral_profiles,
        "title": r"(a) Lateral momentum",
    },
    {
        "profiles": vertical_profiles,
        "title": r"(b) Vertical momentum",
    },
]
