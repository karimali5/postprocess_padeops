    ...
    **kwargs : dict
    ...
    with plt.rc_context({"text.usetex": True, "font.family": "serif"}):
        ...
        if export is not False:
            if export is None:
                export = "lateral_linear_profiles.png"
            print(export)
...
profiles = [
    {
        'file': 
            [
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_baseadv_u_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_baseadv_v_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_baseadv_w_avg_x.csv",
             ],
        'label': r'$\overline{u}_j^b \partial_j \Delta{\overline{v}}$',
        'color': 'k',
        'style': '-',
        'ygain': lineargain,
        "linewidth": lw,
...

    {
        'file': 
            [
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_tiltadv_u_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_tiltadv_v_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_tiltadv_w_avg_x.csv",
                ],
...

    {
        'file': 
            [
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_nonlinadv_u_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_nonlinadv_v_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_nonlinadv_w_avg_x.csv",
                ],
    ...
    {
        'file':'/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_deltap_avg_x.csv',
...

    {
        'file': 
        [
            "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_Reynolds_dvdu_avg_x.csv",
            "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_Reynolds_dvdv_avg_x.csv",
            "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_Reynolds_dvdw_avg_x.csv",
        ],
        ...
        'file': 
            [
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_Reynolds_dvbu_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_Reynolds_dvbv_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_Reynolds_dvbw_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_Reynolds_bvdu_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_Reynolds_bvdv_avg_x.csv",
                "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_Reynolds_bvdw_avg_x.csv",
            ],
    ...
    {
        'file':'/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_SGS_avg_x.csv',
    ...
    {
        'file':'/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/y_COR_avg_x.csv',
