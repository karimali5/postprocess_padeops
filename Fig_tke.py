...
profiles = [
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget4_term03_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{A}_{\Delta, bb}$',
        'color': 'tab:brown',
        'style': '-',
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget4_term02_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{A}_{\Delta, b \Delta} + \mathcal{A}_{\Delta, \Delta b}$',
        'color': 'tab:orange',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget4_term01_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{A}_{\Delta, \Delta \Delta}$',
        'color': 'tab:blue',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget4_term05_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{A}_{b, b \Delta}+\mathcal{A}_{b, \Delta b}$',
        'color': 'tab:red',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget4_term04_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{A}_{b, \Delta \Delta}$',
        'color': 'k',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    # {
    #     'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term03_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    #     'label': r'$\mathcal{R}_{\Delta b}$',
    #     'color': 'tab:red',
    #     'style': '-',
    #     'ygain': rmsgain*1000000,
    #     "linewidth": lw,
    #     'offset': 140,
    # },

    # {
    #     'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term02_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    #     'label': r'$\mathcal{R}_{b \Delta}$',
    #     'color': 'tab:blue',
    #     'style': '-',
    #     'ygain': rmsgain*1000000,
    #     "linewidth": lw,
    ...
    # {
    #     'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term01_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    #     'label': r'$\mathcal{R}_{\Delta \Delta}$',
    #     'color': 'k',
    #     'style': '-',
    #     'ygain': rmsgain*1000000,
    #     "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Prod_bbd_rms_x.csv",
        'label': r'$\mathcal{P}_{bb, \Delta}$',
        'color': 'tab:green',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Prod_bdd_rms_x.csv",
        'label': r'$\mathcal{P}_{b \Delta, \Delta}$',
        'color': 'tab:orange',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Prod_dbd_rms_x.csv",
        'label': r'$\mathcal{P}_{\Delta b, \Delta}$',
        'color': 'tab:red',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Prod_ddd_rms_x.csv",
        'label': r'$\mathcal{P}_{\Delta \Delta, \Delta}$',
        'color': 'k',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Prod_bdb_rms_x.csv",
        'label': r'$\mathcal{P}_{b \Delta, b}$',
        'color': 'tab:brown',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Prod_dbb_rms_x.csv",
        'label': r'$\mathcal{P}_{\Delta b, b}$',
        'color': 'cyan',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Prod_ddb_rms_x.csv",
        'label': r'$\mathcal{P}_{\Delta \Delta, b}$',
        'color': 'tab:blue',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    ####
    # {
    #     'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term04_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    #     'label': r'$\mathcal{D}_{b \Delta}$',
    #     'color': 'tab:red',
    #     'style': '-',
    #     'ygain': rmsgain*1000000,
    #     "linewidth": lw,
    ...
    # {
    #     'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term05_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    #     'label': r'$\mathcal{D}_{\Delta b}$',
    #     'color': 'tab:green',
    #     'style': '-',
    #     'ygain': rmsgain*100000,
    #     "linewidth": lw,
    ...
    # {
    #     'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term06_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    #     'label': r'$\mathcal{D}_{\Delta \Delta}$',
    #     'color': 'k',
    #     'style': '-',
    #     'ygain': rmsgain*1000000,
    #     "linewidth": lw,
    ...
    ####
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term18_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{T}_{b \Delta \Delta}$',
        'color': 'tab:orange',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term14_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{T}_{bb \Delta}$',
        'color': 'tab:red',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term15_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{T}_{b \Delta b}$',
        'color': 'tab:blue',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term19_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{T}_{\Delta \Delta \Delta}$',
        'color': 'k',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term16_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{T}_{\Delta b \Delta}$',
        'color': 'cyan',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term17_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{T}_{\Delta \Delta b}$',
        'color': 'tab:green',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term13_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\mathcal{T}_{\Delta bb}$',
        'color': 'tab:purple',
        'style': '-',
        'ygain': rmsgain*100000,
        "linewidth": lw,
    ...
    # {
    #     'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term08_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    #     'label': r'$\varepsilon_{b \Delta}$',
    #     'color': 'tab:blue',
    #     'style': '-',
    #     'ygain': rmsgain*100000,
    #     "linewidth": lw,
    ...
    # {
    #     'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term07_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    #     'label': r'$\varepsilon_{\Delta b}$',
    #     'color': 'tab:red',
    #     'style': '-',
    #     'ygain': rmsgain*100000,
    #     "linewidth": lw,
    ...
    # {
    #     'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget3_term09_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
    #     'label': r'$\varepsilon_{\Delta \Delta}$',
    #     'color': 'k',
    #     'style': '-',
    #     'ygain': rmsgain*100000,
    #     "linewidth": lw,
...
if __name__ == "__main__":
    profile_panels = [
        {"profiles": profiles[0:6], "title":"Advection", "legend_ncols":1},
        #{"profiles": profiles[6:10], "ytop":10, "title":"Pressure Redistribution", "ylabel": r"$\mathrm{RMS}~(\times 10^{-6})$"},
        {"profiles": profiles[6:14], "ytop":8, "title":"Production", "ylabel": r"$\mathrm{RMS}~(\times 10^{-5})$", "legend_ncols": 2},
        # {"profiles": profiles[18:21], "ytop":2, "title":"SGS Transport", "ylabel": r"$\mathrm{RMS}~(\times 10^{-6})$", "legend_ncols": 1},
        {"profiles": profiles[14:22], "ytop":4, "title":"Turbulent Transport", "ylabel": r"$\mathrm{RMS}~(\times 10^{-5})$", "legend_ncols": 2},
        #{"profiles": profiles[26:30], "ytop":4, "title":"Dissipation", "ylabel": r"$\mathrm{RMS}~(\times 10^{-5})$", "legend_ncols": 1},
    ]
    plot_profile_panels(
        profile_panels,
        **plot_style,
