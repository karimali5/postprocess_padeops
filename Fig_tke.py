...
profiles = [
    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget1_term(01+04+06)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\frac{1}{2} \overline{\Delta u_i^\prime \Delta u_i^\prime}$',
        'color': 'k',
        'style': '-',
        'ygain': rmsgain*1000/2,
        "linewidth": lw,
    },

    {
        'file': "/anvil/scratch/x-kali/PadeOpsSims/INV800-5K/profiles/Run09_comp_deficit_budget1_term(07+12+15)_t101691_n019053_rms_x_y23p8-134p93_zmin0p12.csv",
        'label': r'$\overline{\Delta u_i^\prime  {u_i^\prime}^b}$',
        'color': 'tab:red',
        'style': '-',
        'ygain': rmsgain*1000,
        "linewidth": lw,
